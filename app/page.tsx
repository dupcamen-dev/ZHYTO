  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <motion.section 
        ...
        className="relative min-h-[120dvh] flex flex-col items-center justify-center overflow-hidden"
      >
        {/* YouTube video placeholder - replace VIDEO_ID with your YouTube video ID */}
        <div className="absolute inset-0 z-0 overflow-hidden">
          <iframe
            src="https://www.youtube.com/embed/VIDEO_ID?autoplay=1&mute=1&loop=1&playlist=VIDEO_ID&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1&start=0"
            className="absolute top-1/2 left-1/2 w-[177.78vh] h-[100vh] -translate-x-1/2 -translate-y-1/2 pointer-events-none"
