          ...
          >
            <p className="text-[39px] tracking-[0.35em] mb-0">
              <span className="relative inline-block font-script text-black">
                {t.about.ourStory}
                <div className="absolute inset-1/2 -translate-x-1/2 -translate-y-1/2 w-[250%] h-[200%] -z-10">
                  <Image src={img("/images/about-card.webp")} alt="" fill className="object-cover" />
                </div>
              </span>
            </p>
            <div className="w-10 h-px bg-primary/60 mb-10" />
            <p className="text-muted-foreground leading-[1.9] mb-6 text-xl md:text-lg lg:text-xl">
              {t.about.para1}
            </p>
            <p className="text-muted-foreground leading-[1.9] mb-10 text-xl md:text-lg lg:text-xl">
              {t.about.para2}
            </p>
            <a
              href="#contact"
