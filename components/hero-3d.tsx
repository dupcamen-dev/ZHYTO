...
export function Hero3D() {
  ...
  return (
    <div className="relative w-full max-w-[200px] aspect-square sm:w-[350px] sm:h-[350px] lg:w-[1000px] lg:h-[1200px] xl:w-[1000px] xl:h-[1200px] 2xl:w-[1000px] 2xl:h-[1200px]">
      {!ready && (
